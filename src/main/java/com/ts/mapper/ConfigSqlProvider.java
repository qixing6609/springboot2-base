...
import com.ts.model.ConfigExample.Criteria;
import com.ts.model.ConfigExample.Criterion;
...
public class ConfigSqlProvider {
     ...
     * @mbggenerated
     */
    protected void applyWhere(ConfigExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
